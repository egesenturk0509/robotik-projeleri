            ...
            <tr>
              <td class="content">
                ...
                <div style="text-align: center;">
                  <a href="https://robotik-projelerim.vercel.app" class="btn">Portalı Ziyaret Et</a>
                </div>
              </td>
            </tr>
            <tr>
              <td class="footer">
                Bu mail Robotik Mühendisliği Portalı üzerinden talebiniz üzerine gönderilmiştir.
              </td>
            </tr>
          </table>
        </div>
